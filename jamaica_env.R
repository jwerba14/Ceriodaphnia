...
ggstatsplot::ggcoefstats(
  ...
  scale_y_discrete(labels = c("Abundance: Temperature", "Abundance: Salinity","Abundance: Oxygen", 
                            "Abundance: pH", "Presence: Salinity", "Presence: Oxygen",'Presence: pH',  
                            'Presence: Temperature', 'NA'))
